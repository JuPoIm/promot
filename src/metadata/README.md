 ...
 * [promot.yml](promot.yml)
     * Determines how your purl.obolibrary.org/obo/promot/ redirects will be handled
     ...
     * Paste in the contents of [promot.yml](promot.yml)
 ...
 * [promot.md](promot.md)
     ...
     * Paste in the contents of [promot.md](promot.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
